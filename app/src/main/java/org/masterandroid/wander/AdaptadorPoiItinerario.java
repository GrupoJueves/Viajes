...
public class AdaptadorPoiItinerario extends RecyclerView.Adapter<AdaptadorPoiItinerario.ViewHolder> {

    private LayoutInflater inflador;//Crea Layouts a partir del XML
    private long id;

    private Cursor c;
    private AdaptadorPoiItinerario.OnItemClickListener escucha;
    ...
    interface OnItemClickListener {
        public void onClick(AdaptadorPoiItinerario.ViewHolder holder, long id);
    }



    // Constructor
    public AdaptadorPoiItinerario(Context contexto, Cursor c, AdaptadorPoiItinerario.OnItemClickListener escucha) {
        this.c=c;
    ...
    @Override
    public AdaptadorPoiItinerario.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new AdaptadorPoiItinerario.ViewHolder(vista);
    }

    @Override
    public void onBindViewHolder(AdaptadorPoiItinerario.ViewHolder holder, int position) {
